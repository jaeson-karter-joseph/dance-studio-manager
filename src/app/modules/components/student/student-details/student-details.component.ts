...
export class StudentDetailsComponent {
  ...
  editProduct(studentDetailsProduct: StudentDetails) {
    console.log({ ...studentDetailsProduct });
    this.StudentDetails = { ...studentDetailsProduct };
  ...
  saveProduct() {
    ...
    if (this.studentDetailsProduct.name?.trim()) {
      if (this.studentDetailsProduct.studentID) {
        this.studentDetailsProducts[this.findIndexById(this.studentDetailsProduct.studentID)] = this.studentDetailsProduct;
        this.messageService.add({ severity: 'success', summary: 'Successful', detail: 'Product Updated', life: 3000 });
      } else {
        this.studentDetailsProduct.studentID = this.createId();
        this.studentDetailsProduct.image = 'product-placeholder.svg';
